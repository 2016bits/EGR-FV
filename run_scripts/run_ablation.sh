...
CONFIG=configs/ablation_two_branch.yaml sh run_scripts/run_eval.sh
CONFIG=configs/ablation_routing_only.yaml sh run_scripts/run_eval.sh
CONFIG=configs/ablation_random_remix_only.yaml sh run_scripts/run_eval.sh
CONFIG=configs/ablation_full_wo_remix.yaml sh run_scripts/run_eval.sh
CONFIG=configs/ablation_full_wo_evidence_contrast.yaml sh run_scripts/run_eval.sh
CONFIG=configs/ablation_full_wo_grounded_dominant.yaml sh run_scripts/run_eval.sh
CONFIG=configs/ablation_full_hard_routing.yaml sh run_scripts/run_eval.sh
CONFIG=configs/ablation_full_in_sample_routing.yaml sh run_scripts/run_eval.sh
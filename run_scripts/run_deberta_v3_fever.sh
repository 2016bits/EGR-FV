#!/bin/sh
# Full EGR-FV + claim-evidence baseline on FEVER, DeBERTa-v3-base backbone.
...
CONFIG="${CONFIG:-configs/backbones/deberta_v3_fever.yaml}"
SYM_CONFIG="${SYM_CONFIG:-configs/backbones/deberta_v3_fever_symmetric.yaml}"
BASELINE_CONFIG="${BASELINE_CONFIG:-configs/backbones/baseline_claim_evidence_deberta_v3_fever.yaml}"
BASELINE_SYM_CONFIG="${BASELINE_SYM_CONFIG:-configs/backbones/baseline_claim_evidence_deberta_v3_fever_symmetric.yaml}"
...
echo "[deberta_v3 fever] finish time: $(date)"
